...
**Совет:** MCP Gateway, Ollama, LiteLLM, Whisper, Kokoro и Embeddings можно [использовать совместно](#использование-с-другими-ai-сервисами) для создания полного self-hosted стека ИИ на вашем сервере — с доступом к инструментам, локальными LLM, голосовым вводом/выводом и семантическим поиском. См. [Docker AI Stack](https://github.com/hwdsl2/docker-ai-stack) — готовые конфигурации и примеры конвейеров.
